...
def register_extra_commands(
    ...
    class ClipReviewView(discord.ui.View):
        def __init__(self, db, submitter_id, post_url, submitter_user, campaign_name="—"):
            ...
            try:
                ...
                if config and config.get("channel_id"):
                    ...
                    if channel:
                        ...
                        review_view = ClipReviewView(self.db, interaction.user.id, url, interaction.user, camp.get("name", "—"))
